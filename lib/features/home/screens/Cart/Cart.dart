        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () => Get.to(() => OrderDetails(items: cartController.getCheckedItems(),)),
                child: Container(
                  height: 40,
                  width: 140,
                  decoration: BoxDecoration(
                  ...
                  child: Center(
                    ...
                    () => Text(
                      ...
                      'Checkout (${cartController.noOfCartItems})',
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 16,
                        ...
                        child: Obx(
                          () => Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    width: 1.5, color: TColors.grayFont)),
                            child: cartController.isAllChecked.value
                                ? Icon(Icons.check,
                                    size: 16, color: TColors.grayFont)
                                : null,
                          ),
                        )),
                    SizedBox(
