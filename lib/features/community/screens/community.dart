            ...
            child: FloatingActionButton(
              onPressed: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Addthreads()));
              },
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Obx(() {
                          final isSearching =
                              threadController.searchResults.isNotEmpty ||
                                  threadController.isSearching.value;

                          if (isSearching &&
                              threadController.searchResults.isEmpty) {
                            return Center(
                              child: Text(
                                "Thread not found",
                                style: TextStyle(
                          ...
                          final displayedThreads = isSearching
                              ? threadController.searchResults
                              : threadController.threadsList;
