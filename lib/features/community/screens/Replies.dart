                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Image(image: AssetImage(TImages.user), height: 30,),
                                Text('@pawrenting_user', style: TextStyle(fontFamily: 'alata', fontSize: 13, color: Color(0xff4E4E4E)),),
                            ...
                            Row(
                              children: [
                                Text("Tolongggg kucing saya kaburrrr ...", style: TextStyle(fontFamily: 'albertsans', fontSize: 16, fontWeight: FontWeight.bold),)
                              ],
                            ),

                            Row(
                              children: [
                                Text("Bagi teman-teman yang bisa menemukan kucing\nsaya,tolong hubungi saya di no 082917353728. Saya...", 
                                style: TextStyle(fontFamily: 'alata', fontSize: 13) ,)
                              ],
                            )
                          ],
                        ),
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Column(
                                  children: [
                                    Image(image: AssetImage(TImages.forwardarrow2),height: 30,)
                                  ],
                                ),
                                ...
                                Column(
                                  children: [
                                    Container(
                                      ...
                                      height: 60,
                                      width: 300,
                                      padding: EdgeInsets.only(left: 12, right: 10, top: 10, bottom: 5),
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                          Text('Replying to @isaurazry_', style: TextStyle(fontFamily: 'alata', fontSize: 13, color: Color(0xff4E4E4E)),),
                                          Text('2 days ago', style: TextStyle(fontFamily: 'alata', fontSize: 11, color: Color(0xff4E4E4E)),)
                                        ],
                                      ),
                                      Row(
                                        children: [
                                           Row(
                                          children: [
                                          Text('Terima kasih ya kak. Mohon bantu...', style: TextStyle(fontFamily: 'alata', fontSize: 16, color: Color(0xff4E4E4E)),),
                                        ],
                                      ),
                                        ],
                                      )
