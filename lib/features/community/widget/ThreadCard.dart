                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(message.topic, style: TextStyle(fontFamily: 'albertsans', fontSize: 12, fontWeight: FontWeight.bold),),
                    ),
                    Text(_getTimeDifference(message.createdAt), style: TextStyle(fontSize: 12, color: Color(0xFF4E4E4E), fontFamily: 'alata')),
                  ],
                ),
                SizedBox(height: 8,),
                Row(
            ...
            Container(
                            child: Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 7,),
                                Text(message.likeCount.toString(), style: TextStyle(
                                  fontFamily: 'albertsans',
                                  fontSize: 16,
                                  color: Color(0xff4E4E4E),
                                ),),
                                ...
                                SizedBox(width: 7,),
                                Text(message.commentCount.toString(), style: TextStyle(
                                  fontFamily: 'albertsans',
                                  fontSize: 16,
                                  color: Color(0xff4E4E4E),
                                ),)
